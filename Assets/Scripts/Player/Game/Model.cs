...
{
    public enum PlayerState { waiting, escaper, hunter, spectator };
    public enum GroundState { controled, air, normal, ice, slime };
    public enum FrontState { controled, air, normal, ice, slime };
    // public enum MoveState { underControl, isDashing, isRunning, isSquating, isSliding };
    ...
    public class Model : MonoBehaviour
    {
        ...
        [SerializeField] float dashPower = 80f;
